...
namespace BestHTTP
{
    ...
    internal abstract class ConnectionBase : IDisposable
    {
        ...
        /// </summary>
		public HTTPConnectionStates _State;// { get; protected set; }
		public HTTPConnectionStates State
		{
			set
			{ 
				_State = value;
				if(HTTPManager.BeShowHttpLog)UnityEngine.Debug.LogError ("999--->ConnectionBase State:"+_State);
			}
			get
			{
				return _State;
...
#pragma warning restore 4014
        ...
        internal void HandleCallback()
        {
            try
            {
				...
				{
					if(HTTPManager.BeShowHttpLog)UnityEngine.Debug.LogError("999---->ConectionBase  State:"+State);
