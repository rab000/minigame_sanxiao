...
namespace BestHTTP
{
    ...
    internal sealed class FileConnection : ConnectionBase
    {
        ...
        protected override void ThreadFunc(object param)
        {
            ...
            catch(Exception ex)
            {
				if (CurrentRequest != null) {
					if (HTTPManager.BeShowHttpLog)
						UnityEngine.Debug.LogError ("999--->FileConnection.ThreadFunc CurrentRequest!=null ex:" + ex);
            ...
            {
				if (HTTPManager.BeShowHttpLog)
					UnityEngine.Debug.LogError ("999--->FileConnection.ThreadFunc State=Closed");
