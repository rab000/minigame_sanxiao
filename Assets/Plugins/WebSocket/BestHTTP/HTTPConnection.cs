            ...
            void ThreadFunc(object param)
        {
            ...
            catch(TimeoutException e)
            {
				if (HTTPManager.BeShowHttpLog)
					UnityEngine.Debug.LogError ("999--->HttpConnection.ThreadFunc timeOutException ex:" + e);
                CurrentRequest.Response = null;
            ...
            catch (Exception e)
            {
				if (CurrentRequest != null) {
					if (HTTPManager.BeShowHttpLog)
						UnityEngine.Debug.LogError ("999--->HttpConnection.ThreadFunc CurrentRequest != null ex:" + e);
#if !BESTHTTP_DISABLE_CACHING && (!UNITY_WEBGL || UNITY_EDITOR)
                ...
                if (CurrentRequest != null)
                {
                    ...
                    lock (HTTPManager.Locker)
                    {
						...
						if (CurrentRequest.State == HTTPRequestStates.ConnectionTimedOut) {
							if (HTTPManager.BeShowHttpLog)
								UnityEngine.Debug.LogError ("999--->HttpConnection.ThreadFunc timeOut State=Close");
